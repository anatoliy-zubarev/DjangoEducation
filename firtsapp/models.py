...
class Pizza(models.Model):
    ...
    name = models.CharField(max_length=30, verbose_name='Назване пиццы')
    short_discription = models.CharField(max_length=30, verbose_name='Краткое описание пиццы')
    price = models.IntegerField(default=0, verbose_name='Цена')
    photo = models.ImageField('Фото', upload_to='firtsapp/photos', default='', blank=True)
